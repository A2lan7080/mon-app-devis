...
export default function AdminShell({
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-slate-100 text-slate-900 md:h-screen md:overflow-hidden">
      ...
      <button
        ...
        className="bf-button-primary fixed right-4 top-6 z-40 shadow-xl md:hidden"
      >
        Menu
      </button>
          ...
          <div className="absolute inset-y-0 left-0 flex w-[86%] max-w-sm flex-col bg-white shadow-2xl">
            <div className="shrink-0 border-b border-slate-100 p-4">
              <div className="flex items-start justify-between gap-3">
                ...
                <button
                  onClick={() => setMenuMobileOuvert(false)}
                  className="bf-button-secondary min-h-0 shrink-0 px-3 py-2"
                >
                  Fermer
                </button>
              </div>
