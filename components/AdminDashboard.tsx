...
type AdminDashboardProps = {
  ...
  setEntreprise: Dispatch<SetStateAction<Entreprise>>;
  logoPreviewUrl: string;
  setLogoPreviewUrl: Dispatch<SetStateAction<string>>;
};
    ...
    <>
      ...
      <div className="mt-4 grid gap-4 sm:mt-6 sm:gap-6 xl:grid-cols-[minmax(0,1.2fr)_minmax(320px,0.8fr)]">
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Ces champs préparent la personnalisation de l’application.
              </p>
            </div>
        ...
        <div className="rounded-2xl bg-white p-4 shadow-sm sm:p-6">
          ...
          <p className="mt-1 text-sm text-slate-500">
            Prépare l’identité visuelle pour les futurs PDF et emails.
          </p>
