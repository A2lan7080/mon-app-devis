...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Exemple de devis professionnel BatiFlow",
    description:
      "Un exemple concret de devis bâtiment clair, professionnel et prêt à envoyer.",
    url: "/exemple-devis",
    siteName: "BatiFlow",
    locale: "fr_BE",
    type: "website",
          ...
          <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <div>
              ...
              <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-700">
                BatiFlow aide les artisans du bâtiment à produire des devis
                lisibles, avec TVA, totaux automatiques, IBAN et mentions utiles.
              </p>
              <Link
                href="/signup"
            ...
            <article className="rounded-2xl border border-slate-200 bg-white p-4 shadow-[0_24px_70px_rgba(15,23,42,0.14)] sm:p-6">
              <div className="flex flex-col gap-4 border-b border-slate-200 pb-5 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-500">
                    Rénovation cuisine - Menuiserie Dupont
                  </p>
                </div>
              ...
              <div className="mt-5 overflow-hidden rounded-xl border border-slate-200">
                <div className="grid grid-cols-[1fr_52px_92px_92px] gap-3 bg-[#0F172A] px-4 py-3 text-xs font-bold uppercase text-white">
                ...
                {lines.map(([label, qty, price, total]) => (
                  <div
                    key={label}
                    className="grid grid-cols-[1fr_52px_92px_92px] gap-3 border-t border-slate-200 px-4 py-3 text-sm"
                  >
              ...
              <div className="mt-5 grid gap-3 sm:grid-cols-2">
                <div className="rounded-xl bg-[#F1F5F9] p-4 text-sm leading-6 text-slate-700">
                  <p className="font-bold text-[#0F172A]">Mentions incluses</p>
                  <p className="mt-1">TVA, IBAN, coordonnées entreprise et validité du devis.</p>
                </div>
